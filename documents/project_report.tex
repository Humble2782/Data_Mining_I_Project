...
\begin{table}[tb]
  ...
  \begin{tabular}{l c c}
    ...
    \midrule
    number of estimators        & $[50,\,400] \cap \mathbb{Z}$                 & 400 \\
    maximal depth               & $[3,\,20] \cap \mathbb{Z}$                   & 18 \\
    minimum samples per leaf    & $[1,\,20] \cap \mathbb{Z}$                   & 1 \\
    maximal number of features  & \{\texttt{sqrt}, \texttt{log2}\}             & \texttt{sqrt} \\
    ...
    \bottomrule
  \end{tabular}
  \caption{Search space and optimal hyperparameters for the Balanced Random Forest.}
  \label{tab:brf_hyperparams}
\end{table}
...
\begin{table}[tb]
  ...
  \begin{tabular}{l c c}
    ...
    \textbf{Hyperparameter} & \textbf{Search Space} & \textbf{Optimal Value} \\
    \midrule
    iterations          & $[1000,\,7000] \cap \mathbb{Z}$              & 5000 \\
